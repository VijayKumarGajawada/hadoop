...
public class TotTransPerProf {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		Job job1 = Job.getInstance(cobj,"Occupation - totaltxn ");
		...
		FileSystem.get(cobj).delete(outputPath1, true);
		job1.waitForCompletion(true);
		
		Job job2 = Job.getInstance(cobj,"totaltxn - Occupation");
		...
		FileSystem.get(cobj).delete(outputPath2, true);
		job2.waitForCompletion(true);
		
		Job job3 = Job.getInstance(cobj,"Per Occupation - totalTxn");
		...
		FileSystem.get(cobj).delete(new Path(args[2]), true);
